...
Page({
  ...
  data: {
    ...
    isPublish: false,
    publish_result: ["", "发完求助记得也去看看其他小伙伴有没有需要帮助的，互帮互助可以为你积攒人品哦~", "字斟句酌处，亦是与心推敲时，记录学到的知识也是梳理整合的一个过程，感谢你为其他同学带来的宝贵经验！"],
    publish_placeholder: ["请先选择模块进行发布", "把你有的学习资料分享给大家吧~", "分享一下自己成长过程中的经验吧，同学们非常需要你的分享！", ""],
    publishType: "square",
    reward: "",
    shoulRefresh: false
  },
